...
@Component({
  selector: 'app-ware-return-part-add',
  templateUrl: './ware-return-part-add.component.html',
  styleUrls: ['./ware-return-part-add.component.less']
})
export class WareReturnPartAddComponent implements OnInit {
