...
@Component({
  selector: 'app-ware-brand-add',
  templateUrl: 'ware-brand-add.component.html'
})
export class WareBrandAddComponent implements OnInit{
  ...
  submitForm(value) {
    ...
    this.httpClient.post('/api/wms/ware-brand/add', value)
