...
@Component({
  selector: 'app-corp-role-right-scope',
  templateUrl: 'role-right-scope.component.html',
  styleUrls: ['role-right-scope.component.less']
})
export class RoleRightScopeComponent implements OnInit {
