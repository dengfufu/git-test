...
import {FeeConfirmListFilterComponent} from './filter/fee-confirm-list-filter.component';
...
@Component({
  selector: 'app-work-fee-confirm-list',
  templateUrl: './fee-confirm-list.component.html',
  styleUrls: ['./fee-confirm-list.component.less']
})
export class FeeConfirmListComponent implements OnInit {
  ...
  @ViewChild(FeeConfirmListFilterComponent, {static: false}) feeConfirmListFilterComponent: FeeConfirmListFilterComponent;
  ...
  url = '/api/anyfix/work-request/fee-confirm/query';
  ...
  ngOnInit() {
    ...
    if (params && params._type === 'work-fee-confirm') {
      this.params = params;
  ...
  initFormValue() {
    this.searchForm.patchValue({
      ...
      feeConfirmUser: this.params.feeConfirmUser,
      feeConfirmTime: this.params.feeConfirmTime,
      feeConfirmStartDate: this.params.feeConfirmStartDate,
      feeConfirmEndDate: this.params.feeConfirmEndDate,
  ...
  queryWork() {
    // 工单筛选数据收集
    this.feeConfirmListFilterComponent.submit();
    this.stPro.reset();
  }
  ...
  getParams() {
    ...
    if (params.feeConfirmStatuses === undefined) {
      params.feeConfirmStatuses = this.workCheckService.TO_CONFIRM;
    }
    return params;
  }
  ...
  toWorkDetail(workId) {
    ...
    this.params._type = 'work-fee-confirm';
  ...
  checkPassSubmit(idList) {
    ...
    this.loading = true;
    this.httpClient.post('/api/anyfix/work-check/fee/batch-confirm', params)
      .pipe(finalize(() => {
        this.loading = false;
      }))
