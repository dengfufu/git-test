...
// import {WorkOrderFilterComponent} from './filter/work-order-filter.component';
...
export class WorkOrderComponent implements OnInit {
  ...
  // @ViewChild(WorkOrderFilterComponent, {static: false}) WorkOrderFilterComponent: WorkOrderFilterComponent;
  ...
  getParamsValue() {
    const params = this.WorkOrderService.paramsValue;
    if (params) {
      // 解决点击返回键报错问题
      ...
      if(params.formValue.serviceModes ===undefined){
        params.formValue.serviceModes = null;
      }
      console.log(params);
    ...
    this.WorkOrderService.paramsValue = null;
  }
  ...
  //   // 工单筛选数据收集
  //   this.WorkOrderFilterComponent.submit();
  ...
  toWorkDetail(workId) {
    this.WorkOrderService.paramsValue = this.savedPramsValue;
