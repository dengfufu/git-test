...
@Component({
  selector: 'app-work-remind-add',
  templateUrl: 'work-remind-add.component.html'
})
export class WorkRemindAddComponent implements OnInit {
  ...
  districts = [];
  workTypeOptions: any[] = [];
  remindItemList: WorkRemindItem[] = []; // 预警条件列表
  ...
  constructor(private formBuilder: FormBuilder,
    ...
    this.validateForm = this.formBuilder.group({
      remindName: [null, [ZonValidators.required('预警名称'), ZonValidators.maxLength(50), ZonValidators.notEmptyString()]],
      demanderCorp: [null, []],
      serviceBranch: [null, []],
      handleType: [null, []],
      largeClassId: [null, []],
  ...
  submitForm(value: any) {
    ...
    if (this.validateForm.valid) {
      ...
      let params: {};
      const url = '/api/anyfix/work-remind/add';
      params = {
        ...
        serviceCorp: this.serviceCorp || 0,
