...
@TableName("custom_list_d")
@ApiModel(value="CustomListDetail对象", description="自定义列表子表")
public class CustomListDetail implements Serializable {

    private static final long serialVersionUID = 1L;

    @ApiModelProperty(value = "列表值ID")
    @TableId("id")
    private Long id;
