...
public class AddressResolutionUtil {
     ...
     * @return
     */
    public static AddressDto addressFormat(String address) {
        if(address == null) {
            return null;
        };
        ...
        AddressDto rmap = new AddressDto();
        rmap.setProvince(province);
        rmap.setCity(city);
        rmap.setCounty(county);
        rmap.setTown(town + village);
        rmap.setDetailAddress(detailAddress.toString().replaceAll("\\s+",""));
        rmap.setDetailFormat(detailAddress.toString());
        return rmap;
    }
